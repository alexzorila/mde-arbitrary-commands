...
Base64 command encoding can be used for special characters. Addresses: `Error: Please avoid using the following characters as part of scripts' parameters: ; & | ! $ ( )`. 

CyberChef recipies can be employed for ease of use.
